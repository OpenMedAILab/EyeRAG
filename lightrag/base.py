...
class QueryParam:
    ...
    only_need_retrieved_context_list: bool = False # for eye_rag
    only_need_entity_and_relation_str: bool = False # for eye_rag
    ...
    """
    rerank_top_n: int = int(os.getenv("RERANK_TOP_K", str(DEFAULT_RERANK_TOP_K)))
