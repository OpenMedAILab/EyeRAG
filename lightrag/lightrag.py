...
class LightRAG:
    ...
    # """Number of entities/relations (knowledge graph) to retrieve for each query."""
    #
    # chunk_top_k: int = field(
    #     default=get_env_value("CHUNK_TOP_K", DEFAULT_CHUNK_TOP_K, int)
    # )
    # """Maximum number of chunks in context (naive retrieval, without using knowledge graph)."""
    ...
    # """Enables caching for LLM responses to avoid redundant computations."""
    #
    # enable_llm_cache_for_entity_extract: bool = field(default=False)
    # """If True, enables caching for entity extraction steps to reduce LLM costs."""
    ...
    async def aclear_cache(self) -> None:
        ...
        Example:
            # Clear all cache
            await medical_guide_rag.aclear_cache()
        """
