...
async def process_chunks_unified(
    ...
    if query_param.enable_rerank and query and unique_chunks:
        ...
        # rerank_top_k = query_param.chunk_top_k or len(unique_chunks)  # original setting
        rerank_top_k = query_param.rerank_top_n or query_param.chunk_top_k or len(unique_chunks)  # mule setting
